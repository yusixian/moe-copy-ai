...
const BatchScrapePanel = memo(function BatchScrapePanel({
        ...
        return (
          <div className="flex flex-col items-center justify-center gap-4 py-8">
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-sky-100 to-indigo-100">
              <Icon icon="line-md:document-list" className="h-8 w-8 text-sky-500" />
            </div>
            <div className="text-center">
              <h3 className="mb-1 text-base font-semibold text-gray-800">批量抓取文档</h3>
              <p className="text-sm text-gray-500">选择页面上包含链接的区域，批量抓取所有文档</p>
            </div>
            <button
        ...
        return (
          <div className="flex flex-col items-center justify-center gap-4 py-8">
            <div className="flex h-16 w-16 animate-pulse items-center justify-center rounded-full bg-sky-100">
              <Icon icon="mdi:cursor-default-click-outline" className="h-8 w-8 text-sky-500" />
            </div>
            <div className="text-center">
              <h3 className="mb-1 text-base font-semibold text-gray-800">正在选择元素...</h3>
              <p className="text-sm text-gray-500">请在页面上点击包含链接的区域</p>
            </div>
            <button
              onClick={onCancel}
      ...
      case 'error':
        return (
          <div className="flex flex-col items-center justify-center gap-4 py-8">
            ...
            <div className="text-center">
              <h3 className="mb-1 text-base font-semibold text-gray-800">抓取失败</h3>
  ...
  return (
    <div className="rounded-xl border-2 border-sky-200 bg-white p-4 shadow-md">{renderContent()}</div>
  )
})
