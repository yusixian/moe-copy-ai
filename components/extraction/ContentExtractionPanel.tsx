        ...
        return (
          <div className="flex flex-col items-center justify-center gap-4 py-8">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-lg bg-gradient-to-r from-amber-500 to-orange-500 px-6 py-2.5 text-sm font-medium text-white shadow-md transition-all hover:from-amber-600 hover:to-orange-600 hover:shadow-lg"
            >
          ...
          <div className="flex flex-col gap-4">
            ...
            {elementInfo && (
              <div className="flex items-center gap-2 rounded-lg bg-amber-50 px-3 py-2">
                <Icon icon="mdi:tag-outline" className="h-4 w-4 text-amber-600" />
                <span className="text-xs text-gray-600">
                  <span className="rounded bg-amber-200 px-1.5 py-0.5 font-mono text-amber-800">
                    {elementInfo.tagName}
                  </span>
                  {elementInfo.id && (
                    <span className="ml-1 text-gray-500">#{elementInfo.id}</span>
                  )}
